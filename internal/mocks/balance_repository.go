...
// Source: loyalty/internal/domain/balance/repository (interfaces: BalanceRepository)
//
// Generated by this command:
//
//	mockgen -destination=balance_repository.go -package=mocks loyalty/internal/domain/balance/repository BalanceRepository
//
